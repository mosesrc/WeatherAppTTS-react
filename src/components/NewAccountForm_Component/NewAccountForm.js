...
function NewAccountForm() {
  ...
  return (
    <div className="container rounded-4 account-form">
      <form>
        <div className="row d-flex justify-content-center" id="form">
          ...
          <div className="block-three order-1 mt-2 col-12 col-lg-6">
            <div>
              ...
              <div className="input-group input-group-sm mb-3">
                <select className="form-select form-select-sm border-0 " id="selectGroup">
                  <option>2</option>
          ...
          <div className="block-six order-4 mb-4 text-center col-12 col-md-6 flex-nowrap">
            <h4>OR</h4>
            <p>Sign up using</p>
