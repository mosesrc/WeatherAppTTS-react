...
function LoginForm() {
  ...
  return (
    <div className="container w-25 mt-5 mb-5 login-form rounded-4" data-testid="login-form">
      <div className="row d-flex flex-column">
        ...
        <div className="col d-flex justify-content-center login-div">
          <button type="button" onClick={navigateToPageView} className="btn" id="loginBtn">
            Login
          </button>
        </div>
        ...
        <div className="col d-flex justify-content-around">
          <button className="btn btn-secondary social-btns" data-testid="goog">
            <div className="d-flex justify-content-center">
              <GoogleIcon className="me-2" />
              <span>Google</span>
            </div>
          </button>
          <button className="btn btn-secondary social-btns" data-testid="face">
            <div className="d-flex justify-content-center">
